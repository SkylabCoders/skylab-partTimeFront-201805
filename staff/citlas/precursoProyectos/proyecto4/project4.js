...
function pasapalabraPlay (){
	...
	function play(){
		for (i=0;i<questions.length;i++){
			...
			var responde = prompt('Cuál es la respuesta de...' + questions[i].question, 'responde aquí')
			if (responde.toLowerCase() === questions[i].answer){
				console.log('muy bien')
				scoreOK++
			} else if (responde.toLowerCase() === 'pasapalabra'){
	...
	function pasapalabra(){
		for (i=0;i<pasadas.length;i++){
			...
			var responde = prompt('Cuál es la respuesta de...' + questions[pasadas[i]].question, 'responde aquí')
			if (responde.toLowerCase() === questions[pasadas[i]].answer){
				console.log('muy bien')
				scoreOK++
			} else if (responde.toLowerCase() === 'pasapalabra'){
				console.log('has pasadopalabra')
	...
	console.log('Has tenido ' + scoreOK + ' aciertos y ' + scoreBad + ' errores y ' + pasadasCounter + ' pasapalabra')	
	console.log(jugadores.player + ' has tenido ' + jugadores.puntos)
	console.log(jugadores)
	return ('Has tenido ' + scoreOK + ' aciertos y ' + scoreBad + ' errores y ' + pasadasCounter + ' pasapalabra')	
